                ...
                */
                ...
                async function onStart() {
                        ...
                        if (body.startsWith(prefix)) {
                                ...
                                // Check for nixprefix commands (commands that work without prefix)
                        ...
                        // ————————————— CHECK NIXPREFIX ————————————— //
                        // If no prefix was used, only allow commands with nixprefix: true
                        if (!usedPrefix) {
                                if (!command || command.config.nixprefix !== true) {
                                        return; // No prefix used and command doesn't have nixprefix enabled
                                }
                        }
                        ...
                        const vipUsers = config.vipUser || [];
                        if (command.config.vip === true && !vipUsers.includes(senderID)) {
                                return await message.reply("𝐘𝐨𝐮 𝐚𝐫𝐞 𝐧𝐨𝐭 𝐚 𝐕𝐈𝐏 𝐮𝐬𝐞𝐫");
                        }
